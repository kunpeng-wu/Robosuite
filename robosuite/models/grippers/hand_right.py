...
class HandRight(GripperModel):
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/hand_right.xml"), idn=idn)
    ...
    def _important_geoms(self):
        return {
            "left_fingerpad": ["finger_14_right_collision"],
            "right_fingerpad": ["finger_23_right_collision"],
        }
